				...
				<div>
					{
						startChapter === '1' ?
						null :
					<Link to={`/cartoon/${cartoon}/${Number(startChapter) - 1}_${endChapter}`} className=" rounded-full drop-shadow-md active:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 bg-white hover:bg-gray-700">
