...
function CartoonPage() {
  ...
  function check(chapter_number) {
    return userData?.transaction_chapter?.some(
      (val) => val?.chapter_number === chapter_number
    );
  }
              ...
              .map((value, key) => {
                return (
                  <div key={key}>
                    {value.coin === 0 ? (
                      <Link
                        to={`/cartoon/${cartoon}/${value.number_chapter}_${chapter.length}`}
                      >
                        <img
                      ...
                      <Link to={`/login`}>
                        <div className="bg-white opacity-50 w-[118px] absolute rounded-md h-[80px]">
                          <img
                            src="../../public/assets/image/lock.png"
                            className="absolute overflow-hidden rounded-md text-center ml-7 mt-2"
                            height={"50%"}
                            width={"50%"}
                          />
                        </div>
                      ...
                      <div>
                        ...
                        <SpringModal
                          ...
                          cartoon_id={dataCartoon?.cartoon_id}
                        />
                      </div>
                    )}
                  </div>
