...
<div className="p-4 h-screen flex items-center justify-center bg-[url(image/bg.jpg)]">
	<div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
		<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
			<h1 className='text-8xl font-semibold text-center text-gray-300'>
				Login
			...
			<form>
				...
				<div className="mt-5">
					...
					<input type='password' placeholder='Enter Password' className='w-full rounded-full pl-5 mt-4 input input-bordered h-12'
					/>
				</div>
				<div>
